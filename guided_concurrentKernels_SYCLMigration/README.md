...
2. Build the program.
   ...
   **Note**: Enable **INTEL_MAX_GPU** flag during build which supports Intel® Data Center GPU Max 1550 or 1100 to get optimized performace. <br>
   **Note**: Enable **NVIDIA_GPU** flag during build which supports Nvidia GPU. <br>
